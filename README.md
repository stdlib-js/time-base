...
```javascript
import time from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { parseDuration } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.2-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.2-esm/index.mjs';
...
[test-image]: https://github.com/stdlib-js/time-base/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/time-base/actions/workflows/test.yml?query=branch:v0.2.2
