...
```javascript
import time from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { parseDuration } from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-base@v0.2.1-deno/mod.js';
